...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    welcome_message = (
        ...
        "🔔 Хочешь, чтобы я напоминал тебе каждый день вести дневник эмоций? Нажимай на команду /settings и выбирай удобное время или отключи уведомления в любой момент.\n\n"
